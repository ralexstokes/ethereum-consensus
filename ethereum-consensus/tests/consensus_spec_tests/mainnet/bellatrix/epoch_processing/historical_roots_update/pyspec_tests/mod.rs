...
fn test_historical_root_accumulator() {
    let mut test_case = HistoricalRootsUpdateTestCase::<spec::BeaconState>::from("consensus-spec-tests/tests/mainnet/bellatrix/epoch_processing/historical_roots_update/pyspec_tests/historical_root_accumulator");
