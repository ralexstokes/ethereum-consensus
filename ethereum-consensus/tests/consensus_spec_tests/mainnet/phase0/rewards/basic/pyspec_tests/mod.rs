...
fn test_full_delay_max_slots() {
    let  test_case = BasicTestCase::<spec::BeaconState>::from("../consensus-spec-tests/tests/mainnet/phase0/rewards/basic/pyspec_tests/full_delay_max_slots");
...
fn test_full_delay_one_slot() {
    let  test_case = BasicTestCase::<spec::BeaconState>::from("../consensus-spec-tests/tests/mainnet/phase0/rewards/basic/pyspec_tests/full_delay_one_slot");
