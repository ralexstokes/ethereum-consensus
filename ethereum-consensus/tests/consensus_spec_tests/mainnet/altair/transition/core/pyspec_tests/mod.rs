...
use ethereum_consensus::{
    ...
    bellatrix::mainnet::NoOpExecutionEngine,
...
fn test_normal_transition() {
    let mut test_case = CoreTestCase::<spec::BeaconState>::from("../consensus-spec-tests/tests/mainnet/altair/transition/core/pyspec_tests/normal_transition");
