...
fn test_updated_randao_mixes() {
    let mut test_case = RandaoMixesResetTestCase::<spec::BeaconState>::from("consensus-spec-tests/tests/minimal/altair/epoch_processing/randao_mixes_reset/pyspec_tests/updated_randao_mixes");
