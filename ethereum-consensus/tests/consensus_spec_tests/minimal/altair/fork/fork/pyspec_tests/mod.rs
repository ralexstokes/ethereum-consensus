...
use ethereum_consensus::{altair::minimal as spec, phase0::minimal as phase0};
...
fn test_fork_random_low_balances() {
    let  test_case = ForkTestCase::<>::from("../consensus-spec-tests/tests/minimal/altair/fork/fork/pyspec_tests/fork_random_low_balances");
