...
fn test_high_proposer_index() {
    let mut test_case = BlocksTestCase::<spec::BeaconState, spec::SignedBeaconBlock>::from("../consensus-spec-tests/tests/minimal/phase0/sanity/blocks/pyspec_tests/high_proposer_index");
...
fn test_invalid_state_root() {
    let mut test_case = BlocksTestCase::<spec::BeaconState, spec::SignedBeaconBlock>::from("../consensus-spec-tests/tests/minimal/phase0/sanity/blocks/pyspec_tests/invalid_state_root");
