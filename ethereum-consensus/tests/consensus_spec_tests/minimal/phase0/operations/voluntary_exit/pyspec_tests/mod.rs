...
#[test]
fn test_success() {
    let mut test_case = VoluntaryExitTestCase::<spec::BeaconState, spec::SignedVoluntaryExit>::from("../consensus-spec-tests/tests/minimal/phase0/operations/voluntary_exit/pyspec_tests/success");
