...
fn test_attester_slashing() {
    let mut test_case = BlocksTestCase::<spec::BeaconState, spec::SignedBeaconBlock>::from("../consensus-spec-tests/tests/minimal/bellatrix/sanity/blocks/pyspec_tests/attester_slashing");
    let execution_engine = spec::DefaultExecutionEngine::default();
    test_case.execute(|state, blocks, validation, context| {
        for block in blocks.iter_mut() {
            spec::state_transition(state, block, &execution_engine, validation, context)?;
...
fn test_deposit_in_block() {
    let mut test_case = BlocksTestCase::<spec::BeaconState, spec::SignedBeaconBlock>::from("../consensus-spec-tests/tests/minimal/bellatrix/sanity/blocks/pyspec_tests/deposit_in_block");
    let execution_engine = spec::DefaultExecutionEngine::default();
    test_case.execute(|state, blocks, validation, context| {
        for block in blocks.iter_mut() {
            spec::state_transition(state, block, &execution_engine, validation, context)?;
...
fn test_historical_batch() {
    let mut test_case = BlocksTestCase::<spec::BeaconState, spec::SignedBeaconBlock>::from("../consensus-spec-tests/tests/minimal/bellatrix/sanity/blocks/pyspec_tests/historical_batch");
    let execution_engine = spec::DefaultExecutionEngine::default();
    test_case.execute(|state, blocks, validation, context| {
        for block in blocks.iter_mut() {
            spec::state_transition(state, block, &execution_engine, validation, context)?;
...
fn test_invalid_block_sig() {
    let mut test_case = BlocksTestCase::<spec::BeaconState, spec::SignedBeaconBlock>::from("../consensus-spec-tests/tests/minimal/bellatrix/sanity/blocks/pyspec_tests/invalid_block_sig");
    let execution_engine = spec::DefaultExecutionEngine::default();
    test_case.execute(|state, blocks, validation, context| {
        for block in blocks.iter_mut() {
            spec::state_transition(state, block, &execution_engine, validation, context)?;
...
fn test_proposer_slashing() {
    let mut test_case = BlocksTestCase::<spec::BeaconState, spec::SignedBeaconBlock>::from("../consensus-spec-tests/tests/minimal/bellatrix/sanity/blocks/pyspec_tests/proposer_slashing");
    let execution_engine = spec::DefaultExecutionEngine::default();
    test_case.execute(|state, blocks, validation, context| {
        for block in blocks.iter_mut() {
            spec::state_transition(state, block, &execution_engine, validation, context)?;
