...
#[test]
fn test_case_0() {
    let  test_case = SignedContributionAndProofTestCase::<>::from("../consensus-spec-tests/tests/minimal/bellatrix/ssz_static/SignedContributionAndProof/ssz_max/case_0");
