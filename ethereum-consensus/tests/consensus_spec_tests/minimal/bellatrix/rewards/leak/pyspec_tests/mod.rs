...
fn test_full_random_leak() {
    let  test_case = LeakTestCase::<spec::BeaconState>::from("../consensus-spec-tests/tests/minimal/bellatrix/rewards/leak/pyspec_tests/full_random_leak");
...
fn test_quarter_full_leak() {
    let  test_case = LeakTestCase::<spec::BeaconState>::from("../consensus-spec-tests/tests/minimal/bellatrix/rewards/leak/pyspec_tests/quarter_full_leak");
