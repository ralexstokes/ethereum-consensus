...
pub use crate::{
    bellatrix::presets::minimal::{
        ...
        SyncAggregate, SyncCommittee, SyncCommitteeContribution, SyncCommitteeMessage, Transaction,
        ...
        PROPORTIONAL_SLASHING_MULTIPLIER_BELLATRIX, SLOTS_PER_HISTORICAL_ROOT, SYNC_COMMITTEE_SIZE,
