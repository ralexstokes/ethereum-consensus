...
pub use crate::{
    ...
    electra::{
        ...
        beacon_state::{
            BeaconState, DepositReceipt, ExecutionLayerWithdrawalRequest, PendingConsolidation,
        ...
        block_processing::{
            ...
            process_consolidation_request, process_deposit_receipt, process_deposit_request,
        ...
        epoch_processing::{
            process_effective_balance_updates, process_epoch, process_pending_consolidations,
            process_pending_deposits, process_registry_updates,
        },
