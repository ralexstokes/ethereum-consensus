...
use crate::phase0::state_transition::errors::{
    invalid_header_error, invalid_operation_error, Error, InvalidAttestation,
...
use crate::phase0::state_transition::{
    ...
    is_slashable_validator, is_valid_indexed_attestation, slash_validator, Context,
};
