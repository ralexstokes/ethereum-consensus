...
pub const MIN_DEPOSIT_AMOUNT: Gwei = 10usize.pow(9);
pub const MAX_EFFECTIVE_BALANCE: Gwei = 32usize * 10usize.pow(9);
pub const EFFECTIVE_BALANCE_INCREMENT: Gwei = 10usize.pow(9);
