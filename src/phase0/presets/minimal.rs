...
pub const MIN_DEPOSIT_AMOUNT: Gwei = 10u64.saturating_pow(9);
pub const MAX_EFFECTIVE_BALANCE: Gwei = 32 * 10u64.saturating_pow(9);
pub const EFFECTIVE_BALANCE_INCREMENT: Gwei = 10u64.saturating_pow(9);
...
pub const INACTIVITY_PENALTY_QUOTIENT: u64 = 2u64.saturating_pow(25);
