...
use spec::{
    compute_domain, compute_epoch_at_slot, get_beacon_committee,
    get_beacon_proposer_index, get_committee_count_per_slot, get_current_epoch,
    get_domain, get_indexed_attestation, get_previous_epoch, get_randao_mix,
    ...
    BeaconBlockHeader, BeaconState, Deposit, DepositMessage, ProposerSlashing,
    SignedVoluntaryExit, Validator, DEPOSIT_CONTRACT_TREE_DEPTH,
};
use ssz_rs::prelude::*;
