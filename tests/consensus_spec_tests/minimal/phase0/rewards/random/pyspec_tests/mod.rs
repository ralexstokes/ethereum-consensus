...
fn test_full_random_low_balances_0() {
    let  test_case = RandomTestCase::<spec::BeaconState>::from("consensus-spec-tests/tests/minimal/phase0/rewards/random/pyspec_tests/full_random_low_balances_0");
...
fn test_full_random_low_balances_1() {
    let  test_case = RandomTestCase::<spec::BeaconState>::from("consensus-spec-tests/tests/minimal/phase0/rewards/random/pyspec_tests/full_random_low_balances_1");
...
fn test_full_random_misc_balances() {
    let  test_case = RandomTestCase::<spec::BeaconState>::from("consensus-spec-tests/tests/minimal/phase0/rewards/random/pyspec_tests/full_random_misc_balances");
...
fn test_full_random_without_leak_0() {
    let  test_case = RandomTestCase::<spec::BeaconState>::from("consensus-spec-tests/tests/minimal/phase0/rewards/random/pyspec_tests/full_random_without_leak_0");
...
fn test_full_random_without_leak_and_current_exit_0() {
    let  test_case = RandomTestCase::<spec::BeaconState>::from("consensus-spec-tests/tests/minimal/phase0/rewards/random/pyspec_tests/full_random_without_leak_and_current_exit_0");
