...
fn test_flush_slashings() {
    let mut test_case = SlashingsResetTestCase::<spec::BeaconState>::from("consensus-spec-tests/tests/minimal/phase0/epoch_processing/slashings_reset/pyspec_tests/flush_slashings");
