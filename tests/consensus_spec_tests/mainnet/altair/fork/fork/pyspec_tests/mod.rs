...
fn test_altair_fork_random_mismatched_attestations() {
    let test_case = TestRunner::from("consensus-spec-tests/tests/mainnet/altair/fork/fork/pyspec_tests/altair_fork_random_mismatched_attestations");
    test_case.execute();
}

#[test]
fn test_altair_fork_random_duplicate_attestations() {
    let test_case = TestRunner::from("consensus-spec-tests/tests/mainnet/altair/fork/fork/pyspec_tests/altair_fork_random_duplicate_attestations");
    test_case.execute();
}
...
fn test_fork_next_epoch_with_block() {
    let test_case = TestRunner::from("consensus-spec-tests/tests/mainnet/altair/fork/fork/pyspec_tests/fork_next_epoch_with_block");
    test_case.execute();
}

#[test]
fn test_fork_random_misc_balances() {
    let test_case = TestRunner::from("consensus-spec-tests/tests/mainnet/altair/fork/fork/pyspec_tests/fork_random_misc_balances");
    test_case.execute();
}

#[test]
fn test_altair_fork_random_misc_balances() {
    let test_case = TestRunner::from("consensus-spec-tests/tests/mainnet/altair/fork/fork/pyspec_tests/altair_fork_random_misc_balances");
    test_case.execute();
}
...
fn test_altair_fork_random_low_balances() {
    let test_case = TestRunner::from("consensus-spec-tests/tests/mainnet/altair/fork/fork/pyspec_tests/altair_fork_random_low_balances");
    test_case.execute();
}
