...
fn test_full_random_without_leak_and_current_exit_0() {
    let test_case = TestRunner::from("consensus-spec-tests/tests/mainnet/phase0/rewards/random/pyspec_tests/full_random_without_leak_and_current_exit_0");
    test_case.execute();
}

#[test]
fn test_full_random_low_balances_0() {
    let test_case = TestRunner::from("consensus-spec-tests/tests/mainnet/phase0/rewards/random/pyspec_tests/full_random_low_balances_0");
    test_case.execute();
}
...
fn test_full_random_low_balances_1() {
    let test_case = TestRunner::from("consensus-spec-tests/tests/mainnet/phase0/rewards/random/pyspec_tests/full_random_low_balances_1");
    test_case.execute();
}
...
fn test_full_random_misc_balances() {
    let test_case = TestRunner::from("consensus-spec-tests/tests/mainnet/phase0/rewards/random/pyspec_tests/full_random_misc_balances");
    test_case.execute();
}
...
fn test_full_random_without_leak_0() {
    let test_case = TestRunner::from("consensus-spec-tests/tests/mainnet/phase0/rewards/random/pyspec_tests/full_random_without_leak_0");
    test_case.execute();
}
